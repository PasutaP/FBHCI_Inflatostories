...
// DATA_P dataPoint_5 = {12,  ,   0, 25,  6,  9}; // set to nine to reach 12
...
void setup() {
  ...
  //  pinMode(SWITCH_LED, OUTPUT);
    ...
    ch2.begin(15500,BIGBAG_SAFETY_PRESSURE_LIMIT-250,BIGBAG_SAFETY_PRESSURE_LIMIT, TIMEOUT);//(15500,MEDIUM_NYLON_SURFACE_STRUCTURE_SAFETY_PRESSURE_LIMIT-250,MEDIUM_NYLON_SURFACE_STRUCTURE_SAFETY_PRESSURE_LIMIT);

    ch3.begin(15500,BIGBAG_SAFETY_PRESSURE_LIMIT-250,BIGBAG_SAFETY_PRESSURE_LIMIT, TIMEOUT);//(15500,LENKRAD_SAFETY_PRESSURE_LIMIT-250,LENKRAD_SAFETY_PRESSURE_LIMIT);

    ch4.begin(15500,BIGBAG_SAFETY_PRESSURE_LIMIT-250,BIGBAG_SAFETY_PRESSURE_LIMIT, TIMEOUT);
    //delay(10000);
